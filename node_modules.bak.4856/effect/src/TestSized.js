...
exports.TestSizedTypeId = Symbol.for("effect/TestSized");
exports.TestSized = Context.GenericTag("effect/TestSized");
class SizedImpl {
    fiberRef;
