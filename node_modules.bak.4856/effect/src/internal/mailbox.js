...
exports.fromStream = exports.toStream = exports.toChannel = exports.into = exports.make = exports.isReadonlyMailbox = exports.isMailbox = exports.ReadonlyTypeId = exports.TypeId = void 0;
const Arr = __importStar(require("../Array.js"));
...
const channelExecutor = __importStar(require("./channel/channelExecutor.js"));
const coreChannel = __importStar(require("./core-stream.js"));
const core = __importStar(require("./core.js"));
const circular = __importStar(require("./effect/circular.js"));
const fiberRuntime = __importStar(require("./fiberRuntime.js"));
const stream = __importStar(require("./stream.js"));
exports.TypeId = Symbol.for("effect/Mailbox");
exports.ReadonlyTypeId = Symbol.for("effect/Mailbox/ReadonlyMailbox");
const isMailbox = (u) => (0, Predicate_js_1.hasProperty)(u, exports.TypeId);
exports.isMailbox = isMailbox;
const isReadonlyMailbox = (u) => (0, Predicate_js_1.hasProperty)(u, exports.ReadonlyTypeId);
...
class MailboxImpl extends Effectable.Class {
    ...
    [exports.ReadonlyTypeId] = exports.ReadonlyTypeId;
    state = {
        _tag: "Open",
        takers: new Set(),
        offers: new Set(),
    ...
    unsafeTake() {
        if (this.state._tag === "Done") {
            return core.exitZipRight(this.state.exit, core.exitFail(new Cause_js_1.NoSuchElementException()));
        }
        let message;
    ...
    take = core.suspend(() => this.unsafeTake() ?? core.zipRight(this.awaitTake, this.take));
    await = core.asyncInterrupt((resume) => {
        if (this.state._tag === "Done") {
    ...
    offerRemainingSingle(message) {
        return core.asyncInterrupt((resume) => {
            ...
            const entry = { _tag: "Single", message, resume };
    ...
    offerRemainingArray(remaining) {
        return core.asyncInterrupt((resume) => {
            ...
            const entry = { _tag: "Array", remaining, offset: 0, resume };
            this.state.offers.add(entry);
            return core.sync(() => {
                if (this.state._tag === "Open") {
                    this.state.offers.delete(entry);
    ...
    awaitTake = core.asyncInterrupt((resume) => {
        if (this.state._tag === "Done") {
            return resume(this.state.exit);
        }
...
exports.make = make;
exports.into = (0, Function_js_1.dual)(2, (effect, self) => core.uninterruptibleMask((restore) => core.matchCauseEffect(restore(effect), {
    onFailure: (cause) => self.failCause(cause),
    onSuccess: (_) => self.end
})));
const toChannel = (self) => {
    const loop = coreChannel.flatMap(self.takeAll, ([messages, done]) => done
...
const toStream = (self) => stream.fromChannel((0, exports.toChannel)(self));
exports.toStream = toStream;
exports.fromStream = (0, Function_js_1.dual)((args) => stream.isStream(args[0]), (self, options) => core.tap(fiberRuntime.acquireRelease((0, exports.make)(options), (mailbox) => mailbox.shutdown), (mailbox) => {
